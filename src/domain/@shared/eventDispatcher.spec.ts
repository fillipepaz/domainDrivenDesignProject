...
import CustomerChangeAddressEvent from "../customer/event/customerChangeAddressEvent.event";
import CustomerCreatedEvent from "../customer/event/customerCreatedEvent.event";
import CustomerCreatedHandler1 from "../customer/event/handler/enviaConsoleLog1Handler";
import CustomerCreatedHandler2 from "../customer/event/handler/enviaConsoleLog2Handler";
import CustomerChangeAddressHandler from "../customer/event/handler/enviaConsoleLogHandler";
import Address from "../customer/value-object/address";
import SendEmailWhenProductIsCreatedHandler from "../product/event/handler/sendEmailWhenProductIsCreated";
