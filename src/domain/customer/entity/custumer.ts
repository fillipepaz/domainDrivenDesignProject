...
import CustomerCreatedEvent from "../event/customerCreatedEvent.event";
import CustomerCreatedHandler1 from "../event/handler/enviaConsoleLog1Handler";
import CustomerCreatedHandler2 from "../event/handler/enviaConsoleLog2Handler";
import CustomerChangeAddressHandler from "../event/handler/enviaConsoleLogHandler";
...
validate(){
 ...
 changeAddress(address: Address){ // todo o objeto é recriado.
    ...
    const custumerChangeAddressEvent = new CustomerCreatedEvent(
